...
def admin_view_teacher_view(request):
    ...
    return render(request,'admin/admin_view_teacher.html',{'teacher':teachers})
...
def delete_teacher_view(request,pk):
    ...
    user.delete()
    teacher.delete()
    return HttpResponseRedirect('admin/admin-view-teacher')
...
def admin_view_pending_teacher_view(request):
    ...
    return render(request,'admin/admin_view_pending_teacher.html',{'teacher':teachers})
...
def admin_view_teacher_salary_view(request):
    teachers= TMODEL.Teacher.objects.all().filter(status=True)
    return render(request,'admin/admin_view_teacher_salary.html',{'teacher':teachers})
...
def admin_view_course_view(request):
    ...
    return render(request,'admin/admin_view_course.html',{'courses':courses})
